const char page1[] PROGMEM =
   ...
   "   dt=new Date(tm1*1000)\n"
   "   item.innerHTML=dt.toString().split(' ')[0]+' '+dt.toLocaleTimeString()\n"
   "   eval('document.all.r'+i).setAttribute('style',tm1?'':'display:none')\n"
   "  }\n"
   "  oledon=d.o\n"
   "  pb0=d.pbdb\n"
   "  pb1=d.pbm\n"
   ...
   "  a.wea=d.weather\n"
   "  if(a.alert.length) a.wea=d.alert\n"
   " }\n"
   " else if(event == 'alert')\n"
   " {\n"
   "  alert(data)\n"
   ...
   "<table align=\"center\">\n"
   "<tr><td colspan=2><p id=\"time\"></p></td></tr>\n"
